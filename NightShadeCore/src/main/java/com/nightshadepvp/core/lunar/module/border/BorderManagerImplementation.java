package com.nightshadepvp.core.lunar.module.border;
...
import com.nightshadepvp.core.lunar.listener.BorderListener;
...
public class BorderManagerImplementation extends BorderManager {
    ...
    public BorderManagerImplementation(Core plugin) {
        this.plugin = plugin;
