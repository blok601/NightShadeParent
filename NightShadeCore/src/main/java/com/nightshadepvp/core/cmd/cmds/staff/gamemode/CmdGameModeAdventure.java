 ...
 */
public class CmdGameModeAdventure extends NightShadeCoreCommand {

    public CmdGameModeAdventure() {
        this.addAliases("adventure", "a");
    ...
    public void perform() throws MassiveException {
        ...
        senderNS.msg(ChatUtils.message("&bUpdated &f" + player.getName() + "'s &bgamemode to &fadventure"));
    }
}
