 ...
 */
public class CmdWeatherStorm extends NightShadeCoreCommand {

    public CmdWeatherStorm() {
        this.addAliases("storm");
    ...
    public void perform() throws MassiveException {
        ...
        player.sendMessage(ChatUtils.message("&bSet the weather to &fstorm &bin &f" + world.getName()));
    }
}
