...
public class FakePlayerManager {
    ...
    public void setup() {
        ...
        FakePlayer arena = new FakePlayer(arenaArmor, new ItemBuilder(Material.IRON_SWORD).enchantment(Enchantment.DAMAGE_ALL).make(), new Location(MConf.get().getSpawnLocation().asBukkitLocation().getWorld(), 0, 11, 4));
        this.npcs.add(arena);
    }
