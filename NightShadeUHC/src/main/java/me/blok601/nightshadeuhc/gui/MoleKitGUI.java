...
public class MoleKitGUI {
    ...
    public MoleKitGUI(Player player){
        ...
        ItemBuilder tank = new ItemBuilder(Material.DIAMOND_CHESTPLATE).name("&6The Tank").lore("&5Tank Kit&8»").lore("&e- Full Diamond Armor with 5 durability left");
        ItemBuilder enchanter = new ItemBuilder(Material.ENCHANTMENT_TABLE).name("&6The Enchanter").lore("&5Enchanter Kit&8»").lore("&e- 1 Enchanting Table").lore("&e- 64 XP Bottles").lore("&e- 8 Lapis Blocks");
        ItemBuilder healer = new ItemBuilder(Material.GOLDEN_APPLE).name("&6The Healer").lore("&5Healer Kit&8»").lore("&e- 2 Golden Apples").lore("&e- 1 Splash Healing Potion");
        ItemBuilder projectile = new ItemBuilder(Material.BOW).name("&6The Projectile").lore("&5Projectile Kit&8»").lore("&e- 1 Bow").lore("&e- 64 Arrows").lore("&e- 1 Fishing Rod");
