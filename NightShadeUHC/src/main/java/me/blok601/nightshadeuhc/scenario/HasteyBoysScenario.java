...
public class HasteyBoysScenario extends Scenario{
    ...
    public HasteyBoysScenario() {
        super("HasteyBoys", "All tools are enchanted with efficieny 3", new ItemBuilder(Material.WOOD_PICKAXE).enchantment(Enchantment.DIG_SPEED, 3).name("HasteyBoys").make());
    }
